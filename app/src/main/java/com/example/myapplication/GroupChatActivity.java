...
public class GroupChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final FirebaseDatabase database =  FirebaseDatabase.getInstance(Secret.getFbInstance());
        ...
        binding.send.setOnClickListener(v->{
            ...
            database.getReference().child("Group Chat").push().setValue(model)
                    .addOnSuccessListener(aVoid -> Toast.makeText(GroupChatActivity.this, "Msg sent", Toast.LENGTH_SHORT).show());
        });
